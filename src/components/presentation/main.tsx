...
const Main = () => {
  ...
  return (
    <div className='flex-1 flex p-10 md:p-0 items-center justify-center flex-col max-w-[800px] mx-auto'>
      <div>
        ...
        <p className='text-[30px] md:text-[70px] opacity-[0.8] font-ppSemiBold tracking-tighter'>Jhordan Huaman.</p>
        <p className='text-[25px] md:text-[60px] opacity-[0.6]'>I Build things for the web</p>
        <div className='max-w-[500px] text-[13px] md:text-[15px]'>
